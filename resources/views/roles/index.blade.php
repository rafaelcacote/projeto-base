...
<div class="page-wrapper">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex py-1 align-items-center">
                                                <span class="avatar me-2" style="background-image: url(https://ui-avatars.com/api/?name={{ urlencode($role->name) }}&background=1f2937&color=fff)"></span>
                                                <div class="flex-fill">
                                        ...
                                        <td>
                                            <span class="badge bg-blue-lt">{{ $role->permissions->count() }} permissões</span>
                                        </td>
                                        <td class="text-muted">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <a href="{{ route('roles.edit', $role) }}" class="action-btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar">
                                                    <i class="fa-solid fa-pen-to-square fa-lg text-warning"></i>
                                                </a>
                                                <a href="#" class="action-btn" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $role->id }}" title="Excluir">
    ...
    <div class="modal modal-blur fade" id="deleteModal{{ $role->id }}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h3>Tem certeza?</h3>
                    <div class="text-muted">Você realmente deseja excluir o perfil <strong>{{ $role->name }}</strong>? Esta ação não pode ser desfeita.</div>
                </div>
