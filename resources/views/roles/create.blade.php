                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Digite o nome do perfil" required>
                                        @error('name')
                                                    ...
                                                    @foreach($permissions as $permission)
                                                        @if(str_starts_with($permission->name, $module . '.'))
                                                            ...
                                                            <label class="form-check">
                                                                <input class="form-check-input permission-check" type="checkbox" name="permissions[]" value="{{ $permission->name }}" data-module="{{ $module }}" {{ in_array($permission->name, old('permissions', [])) ? 'checked' : '' }}>
